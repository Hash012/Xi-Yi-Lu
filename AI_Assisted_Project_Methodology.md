...
尤其对于跑大规模的数据，一定要多添加监控输出，这是ai的长处，他会有很多输出反馈和多线程监控的花样，但你需告诉ai。初步要先确保能跑通，好调试，之后在减少I/O以节省运行耗时。回显进度条的\<tqdm\>库有一点好用，但在多进程上可能会出问题。

在运行过程中如果为分析性能、提高性能或者增加回显，__“一直卡着”__ 是好用的提示词。

【更新中，完全基于个人的不堪的经验，欢迎指点】
### 尾声
